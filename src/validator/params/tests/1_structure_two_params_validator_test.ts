...
Deno.test('test_two_params_validator_structure', () => {
  ...
  assertEquals(result.validatedParams, ['to', 'project'], 'Two params validator should return correct params');
  assertEquals(result.demonstrativeType, 'to', 'Two params validator should set demonstrative type');
