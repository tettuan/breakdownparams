...
Deno.test('OptionCombinationRule Unit Tests', async (t) => {
  await t.step('should validate zero options rules', () => {
    ...
    logger.debug('Zero options rules', {
      data: { allowedCount: zeroRules.allowedOptions.length, options: zeroRules.allowedOptions },
    });
  ...
  await t.step('should validate two options rules', () => {
    ...
    logger.debug('Two options rules', {
      data: { allowedCount: twoRules.allowedOptions.length, options: twoRules.allowedOptions },
    });
