...
Deno.test('Standard Option Combinations - 3 Options', async (t) => {
  ...
  const combinations = [
    ...
    { 
      args: [DEMO_TYPE, LAYER_TYPE, '--from=input.md', '--destination=output.md', '--adaptation=strict'], 
    ...
    { 
      args: [DEMO_TYPE, LAYER_TYPE, '--destination=output.md', '--input=task', '--adaptation=strict'], 
    ...
    { 
      args: [DEMO_TYPE, LAYER_TYPE, '--destination=output.md', '--adaptation=strict', '--config=test'], 
...
Deno.test('Standard Option Combinations - 4 Options', async (t) => {
  ...
  const combinations = [
    ...
    { 
      args: [DEMO_TYPE, LAYER_TYPE, '--from=input.md', '--destination=output.md', '--input=task', '--adaptation=strict'], 
    ...
    { 
      args: [DEMO_TYPE, LAYER_TYPE, '--from=input.md', '--destination=output.md', '--input=task', '--config=test'], 
    ...
    { 
      args: [DEMO_TYPE, LAYER_TYPE, '--from=input.md', '--destination=output.md', '--adaptation=strict', '--config=test'], 
      expected: { from: 'input.md', destination: 'output.md', adaptation: 'strict', config: 'test' },
      description: 'from + destination + adaptation + config'
    },
    // from + input + adaptation + config
    { 
      args: [DEMO_TYPE, LAYER_TYPE, '--from=input.md', '--input=task', '--adaptation=strict', '--config=test'], 
    ...
    { 
      args: [DEMO_TYPE, LAYER_TYPE, '--destination=output.md', '--input=task', '--adaptation=strict', '--config=test'], 
