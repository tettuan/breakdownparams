...
Deno.test("test_validation_result_structure", () => {
  ...
  assertEquals(Array.isArray(successResult.validatedParams), true, "validatedParams should be an array");
  assertEquals(typeof successResult.demonstrativeType, "string", "demonstrativeType should be a string");
  ...
  assertEquals(Array.isArray(errorResult.validatedParams), true, "validatedParams should be an array");
